...
export function MiniOverlay({
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      {/* Top section - Album art, track info, and lyric */}
      <div className="flex items-center gap-3 px-4 pt-4 flex-1 min-h-0">
        {/* Album Art */}
      ...
      <div className="flex items-center justify-center gap-2 px-4 py-1.5 shrink-0">
        <button
